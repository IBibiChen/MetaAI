...
import lingXiaoZhiLogo from '@/assets/lingxiaozhi-logo.png'
import {
  deleteChat,
  fetchChatFiles,
 ...
 *
 * <p>
 * URL query 只作为上下文入口，不承担权限校验
 * 后续聊天、历史和附件请求继续统一读取 workspace 中的持久化上下文
 */
function applyRouteContext() {
  workspace.applyEmbeddedContext({
    tenantId: queryText('tenantId'),
    userId: queryText('userId'),
    kbId: queryText('kbId'),
    deptIds: queryText('deptIds'),
  })
}
 ...
 *
 * <p>
 * iframe 地址可能由业务系统拼接，空字符串和数组参数不覆盖本地上下文
 *
 * @param key query 参数名
 * @return 规范化后的 query 文本
 */
...
// 收藏入口先隐藏，恢复历史卡片按钮时同步恢复该方法和 Star 图标导入
...
.streaming-stop-button {
  ...
  --n-color: #2f7df6 !important;
  --n-color-hover: #246fe3 !important;
  --n-color-pressed: #1f63d9 !important;
  --n-color-focus: #246fe3 !important;
  --n-border: 1px solid #2f7df6 !important;
  --n-border-hover: 1px solid #246fe3 !important;
  --n-border-pressed: 1px solid #1f63d9 !important;
  --n-border-focus: 1px solid #246fe3 !important;
  --n-text-color: #ffffff !important;
  --n-text-color-hover: #ffffff !important;
  --n-text-color-pressed: #ffffff !important;
  --n-text-color-focus: #ffffff !important;
  box-shadow: 0 6px 16px rgba(47, 125, 246, 0.24);
...
.surface {
  ...
  box-shadow: 0 10px 28px rgba(54, 86, 132, 0.08);
}
...
.history-new-button {
  ...
  --n-color-hover: #f7fbff !important;
  --n-color-pressed: #eef6ff !important;
  --n-color-focus: #f7fbff !important;
  --n-border: 1px solid #2f7df6 !important;
  --n-border-hover: 1px solid #4f94ff !important;
  --n-border-pressed: 1px solid #1f63d9 !important;
  --n-border-focus: 1px solid #4f94ff !important;
  --n-text-color: #2f7df6 !important;
  --n-text-color-hover: #1f63d9 !important;
  --n-text-color-pressed: #1b57bd !important;
  --n-text-color-focus: #1f63d9 !important;
...
.history-new-button:active {
  border-color: #1f63d9 !important;
  background: #eef6ff !important;
}

.history-new-button :deep(.n-button__border),
.history-new-button :deep(.n-button__state-border) {
  border: 1px solid #2f7df6 !important;
}

.history-new-button :deep(.n-button__content) {
  color: #2f7df6;
  font-weight: 700;
}
...
.history-refresh-button {
  --n-text-color-hover: #2f7df6 !important;
  --n-text-color-pressed: #1f63d9 !important;
  --n-text-color-focus: #2f7df6 !important;
  color: #6e7f99;
}
...
.history-item {
  ...
  color: #24324a;
  background: #ffffff;
  box-shadow: 0 4px 12px rgba(47, 125, 246, 0.04);
}
...
.history-item.pinned {
  border-color: #9fb0ff;
  background: linear-gradient(135deg, #dbe4ff 0%, #f3f6ff 48%, #dde5ff 100%);
  box-shadow: 0 8px 22px rgba(91, 110, 199, 0.15);
}

.history-item.active.pinned {
  border: 3px solid #2f7df6;
  background: linear-gradient(135deg, #d5e8ff 0%, #f2f7ff 52%, #e4eaff 100%);
  box-shadow: 0 10px 24px rgba(47, 125, 246, 0.15);
}
...
.history-action-button.is-active {
  ...
  color: #3e4cba;
  background: #e5e9ff;
  box-shadow: 0 3px 10px rgba(79, 95, 186, 0.14);
}
...
.chat-toolbar :deep(.n-radio-group) {
  --n-button-border-color: #c9d7ef !important;
  --n-button-border-color-hover: #8ab9ff !important;
  --n-button-border-color-active: #2f7df6 !important;
  --n-button-box-shadow-focus: 0 0 0 2px rgba(47, 125, 246, 0.16) !important;
  --n-button-color: #ffffff !important;
  --n-button-color-active: #eaf3ff !important;
  --n-button-text-color: #334155 !important;
  --n-button-text-color-hover: #2f7df6 !important;
  --n-button-text-color-active: #2f7df6 !important;
  --n-button-text-color-disabled: #94a3b8 !important;
}

.chat-toolbar :deep(.n-radio-button) {
  font-weight: 650;
}

.chat-toolbar :deep(.n-radio-button--checked) {
  box-shadow: inset 0 0 0 1px rgba(47, 125, 246, 0.08);
}
...
.chat-actions :deep(.n-button) {
  ...
  --n-text-color-hover: #2f7df6 !important;
  --n-text-color-pressed: #1f63d9 !important;
  --n-border-hover: 1px solid #b9d3fb !important;
  --n-border-pressed: 1px solid #9fc5ff !important;
  --n-color-hover: #f3f8ff !important;
  --n-color-pressed: #eaf3ff !important;
}
...
.message-scrollbar {
  background: rgba(234, 241, 250, 0.94);
  box-shadow: inset 0 0 0 1px rgba(203, 214, 230, 0.72);
}
...
.message-bubble {
  ...
  color: #1f2a3d;
  background: #f5f9fc;
  box-shadow: 0 8px 22px rgba(47, 125, 246, 0.06);
}
...
.markdown-body :deep(.code-block-head button:hover) {
  ...
  color: #1f63d9 !important;
  background: #dcecff !important;
}

.markdown-body :deep(.code-block-head button:active) {
  border-color: #86b8ff !important;
  color: #1b57bd !important;
  background: #d2e6ff !important;
}

.markdown-body :deep(.code-block-head button:focus-visible) {
  outline: 2px solid rgba(47, 125, 246, 0.22);
  outline-offset: 2px;
}
...
.composer-input :deep(.n-input) {
  ...
  --n-border: 1px solid #d9e5f5 !important;
  --n-border-hover: 1px solid #b9d3fb !important;
  --n-border-focus: 1px solid #86b8ff !important;
  --n-box-shadow-focus: 0 0 0 2px rgba(47, 125, 246, 0.12) !important;
  --n-text-color: #1f2a3d !important;
}
...
.chat-file-chip.is-uploading .chat-file-status {
  color: #1f63d9;
}

.chat-file-chip.is-uploading .chat-file-indicator {
  background: #2f7df6;
  box-shadow: 0 0 0 2px rgba(47, 125, 246, 0.14);
}
